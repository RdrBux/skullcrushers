...
import rockOneFront from './assets/img/rock1front.png';
import rockTwoFront from './assets/img/rock2front.png';
import rockThreeFront from './assets/img/rock3front.png';
import rockOneBack from './assets/img/rock1back.png';
import rockTwoBack from './assets/img/rock2back.png';
import rockThreeBack from './assets/img/rock3back.png';
import animalOneFront from './assets/img/animal1front.png';
import animalTwoFront from './assets/img/animal2front.png';
import animalThreeFront from './assets/img/animal3front.png';
...
const Data = [
  {
    id: 1,
    name: 'Remera SC Original',
    description: '100% algodón de primera calidad.',
    price: '5999',
    stock: {
      s: 3,
      m: 3,
